...
using QixNameAttribute = Qlik.Engine.QixNameAttribute;
    ...
    public class QixEnumConverter : JsonConverter
    {
        ...
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
        {
            ...
            else
            {
                ...
                if (value.GetType().GetMembers().Where((Func<MemberInfo, bool>) (info => info.Name.Equals(enumName)))
                    .SelectMany((Func<MemberInfo, IEnumerable<object>>) (info =>
                        info.GetCustomAttributes(typeof(QixNameAttribute), true)))
                    .FirstOrDefault() is QixNameAttribute qixNameAttribute2)
